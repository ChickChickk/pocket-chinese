...
const ZHUYIN = {
  initials: [
    ...
    ["ㄌ","l","l","樂"],["ㄍ","g","k","哥"],["ㄎ","k","kʰ","科"],["ㄏ","h","x","喝"],["ㄐ","j","tɕ","基"],["ㄑ","q","tɕʰ","欺"],["ㄒ","x","ɕ","西"],
  ...
  finals: [
    ...
    ["ㄡ","ou","ɤʊ","歐"],["ㄢ","an","an","安"],["ㄣ","en","ən","恩"],["ㄤ","ang","ɑŋ","昂"],["ㄥ","eng","əŋ","冷"],["ㄦ","er","ɑɻ","兒"],
    ...
    ["ㄨㄢ","uan / wan","uan","彎"],["ㄨㄣ","un / wen","uən","溫"],["ㄨㄤ","uang / wang","uaŋ","汪"],["ㄨㄥ","weng","uəŋ","翁"],
    ["ㄩㄝ","üe / yue","yœ","約"],["ㄩㄢ","üan / yuan","yɛn","冤"],["ㄩㄣ","ün / yun","yn","暈"],["ㄩㄥ","iong / yong","iʊŋ","用"],["ㄨㄥ","ong","ʊŋ","翁"]
  ],
  tones: [
