...
(function () {
  ...
  var VOICES = [],
    CHOSEN_VOICE = null;
  // Prefer Mei-Jia: macOS's standard Taiwanese Mandarin voice. The rest of the chain matters —
  // it is what devices WITHOUT that voice fall back to, and it must never reach a mainland (zh-CN)
  // voice while any Taiwan one is available.
  function pickVoice() {
